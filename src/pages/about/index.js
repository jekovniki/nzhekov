            ...
            <section className={styles.page}>
                ...
                <div className={styles.animation}>
                    ...
                    <a className={styles['drupal']} href="/skills">
                            ...
                            <p><strong>Drupal 7, Drupal 8 and Drupal 9</strong></p>
                        </a>
                        <a href="/skills" className={styles['html']}>
                            <p><strong>HTML</strong></p>
                        </a>
                        <a href="/skills" className={styles['cssandscss']}>
                            <p><strong className={styles['css']}>CSS</strong><strong className={styles['and']}>&</strong><strong className={styles['scss']}>SCSS</strong></p>
                        </a>
